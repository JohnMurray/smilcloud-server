/**
 * Context listener for database connection
 */
...
public class MysqlContextListener implements ServletContextListener {
	...
	public void contextInitialized (ServletContextEvent event){
		...
		try {
			conn = DriverManager.getConnection("jdbc:mysql://127.0.0.1/mediacloud?autoReconnect=true&user=root&password=nku2009");
